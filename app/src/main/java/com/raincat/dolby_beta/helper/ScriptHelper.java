...
public class ScriptHelper {
    ...
    public static void startScript() {
        String script = String.format("export ENABLE_FLAC=%s&&export MIN_BR=%s&&export QQ_COOKIE=\"%s\"&&export KUWO_PROXY=%s&&export MIGU_COOKIE=\"%s\"&&libnode.so app.js -a 127.0.0.1 -o %s -p %s",
                ...
                SettingHelper.getInstance().getQqCookie(),SettingHelper.getInstance().getKuwoProxy(),
                SettingHelper.getInstance().getMiguCookie(),SettingHelper.getInstance().getProxyOriginal(), SettingHelper.getInstance().getProxyPort() + ":" + (SettingHelper.getInstance().getProxyPort() + 1));
